...
__MODULE__ = "ʙʀᴏᴀᴅᴅʙ"
__HELP__ =  """🛠 **BANTUAN UNTUK MODULE BROADDB 」**

〄➠ **ᴘᴇʀɪɴᴛᴀʜ: .gikesdb**
〄➠ **ᴘᴇɴᴊᴇʟᴀsᴀɴ: ᴍᴇɴɢɪʀɪᴍ ᴘᴇsᴀɴ sɪᴀʀᴀɴ ɢʀᴜᴘ/ᴘᴇsᴀɴ ᴅᴀᴛᴀʙᴀsᴇ

〄➠ **ᴘᴇʀɪɴᴛᴀʜ: .adddb**
〄➠ **ᴘᴇɴᴊᴇʟᴀsᴀɴ: ᴍᴇɴᴀᴍʙᴀʜᴋᴀɴ ᴅᴀᴛᴀʙᴀsᴇ ʙʀᴏᴀᴅᴄᴀsᴛ**

〄➠ **ᴘᴇʀɪɴᴛᴀʜ: .undb**
〄➠ **ᴘᴇɴᴊᴇʟᴀsᴀɴ: ᴍᴇɴɢʜᴀᴘᴜs ᴅᴀᴛᴀʙᴀsᴇ ʙʀᴏᴀᴅᴄᴀsᴛ**

〄➠ **ᴘᴇʀɪɴᴛᴀʜ: .listdb**
〄➠ **ᴘᴇɴᴊᴇʟᴀsᴀɴ: ᴍᴇʟɪʜᴀᴛ ᴛᴏᴛᴀʟ ᴅᴀᴛᴀʙᴀsᴇ ʙʀᴏᴀᴅᴄᴀsᴛ**

〄➠ **ᴘᴇʀɪɴᴛᴀʜ: .ralldb** 
〄➠ **ᴘᴇɴᴊᴇʟᴀsᴀɴ: ᴍᴇɴɢʜᴀᴘᴜs sᴇᴍᴜᴀ ᴅᴀᴛᴀʙᴀsᴇ ʙʀᴏᴀᴅᴄᴀsᴛ**"""
