...
__MODULE__ = "ʀᴇᴍɪɴɪ"
__HELP__ = """🛠 **BANTUAN UNTUK MODULE REMINI**

〄➠ **ᴘᴇʀɪɴᴛᴀʜ: .remini (ʙᴀʟᴇs ғᴏᴛᴏɴʏᴀ)** 
〄➠ **ᴘᴇɴᴊᴇʟᴀsᴀɴ: ᴜɴᴛᴜᴋ ᴍᴇɴɢʜᴅ/ʜᴀʟᴜsᴋᴀɴ ɢᴀᴍʙᴀʀ**"""
...
async def _(client, message):
    try:
        ...
        api_url = f'https://api.botcahx.eu.org/api/tools/remini?url={foto}&resolusi=2'
